...
export const GET_DATA_MASTER = "getDataMaster";
...
export const SET_DATA_MASTER = "SET_DATA_MASTER";
...
const mutations = {
  ...
  [SET_DATA_MASTER](state, data) {
    if(data.kode == 'agama'){
      state.agamaOptions = data.result
    }else if(data.kode == 'hobi'){
      state.hobiOptions = data.result
    }else if(data.kode == 'citacita'){
      state.citacitaOptions = data.result
    }else if(data.kode == 'jenjangsekolah'){
      state.jenjangOptions = data.result
    }else if(data.kode == 'pendidikan'){
      state.pendidikanOptions = data.result
    }else if(data.kode == 'pekerjaan'){
      state.pekerjaanOptions = data.result
    }else if(data.kode == 'jabatan'){
      state.jabatanOptions = data.result
    }else if(data.kode == 'mengajar'){
      state.mengajarOptions = data.result
    }else if(data.kode == 'penghasilan'){
      state.penghasilanOptions = data.result
    }else if(data.kode == 'statusorangtua'){
      state.statusorangtuaOptions = data.result
    }else if(data.kode == 'statustempattinggal'){
      state.statustempattinggalOptions = data.result
    }else if(data.kode == 'jarakrumah'){
      state.jarakrumahOptions = data.result
    }else if(data.kode == 'transportasi'){
      state.transportasiOptions = data.result
    }
  },
...
const actions = {
  [GET_UID](context) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/get-uid`, token)
      .then((response) => {
  ...
  [GET_MENU](context) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-menu`, localStorage.getItem('user_token'))
      .then((response) => {
  ...
  [GET_DATA_MASTER](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-data-master?kode=${data.kode}`, token)
      .then((response) => {
          context.commit('SET_DATA_MASTER', { result: response.data.result, kode: data.kode })
          resolve(response);
        })
        .catch((error) => {
          reject(error);
  ...
  [GET_WILAYAH](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-wilayah?bagian=${data.bagian}&KodeWilayah=${data.KodeWilayah}`, token)
      .then((response) => {
  ...
  [GET_WILAYAH2023](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-wilayah2023?bagian=${data.bagian}&KodeWilayah=${data.KodeWilayah}`, token)
      .then((response) => {
          context.commit('SET_WILAYAH', { wilayah: response.data.result, kategori: data.bagian })
          resolve(response);
        })
  ...
  [GET_BERKAS](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-berkas${data.kategori ? `?kategori=${data.kategori}` : ''}${data.jenis ? `&jenis=${data.jenis}` : ''}`, token)
      .then((response) => {
  ...
  [GET_USER_BROADCAST](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-user-broadcast?kategori=${data.kategori}${data.kode === 1 ? `&kode=${data.kode}` : ''}`, localStorage.getItem('user_token'))
      .then((response) => {
  ...
  [GET_KELAS](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/options-kelas?kondisi=${data.kondisi}${data.walikelas ? `&walikelas=${data.walikelas}` : ''}`, token)
      .then((response) => {
  ...
  [GET_SEQUENCEMENU](context) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/sequence-menu`, token)
      .then((response) => {
  ...
  [POST_SEQUENCEMENU](context, bodyData) {
    return new Promise((resolve, reject) => {
      ApiService.post(`settings/sequence-menu`, token, bodyData)
      .then((response) => {
          resolve(response);
        })
        .catch((error) => {
  ...
  [GET_ROLEMENU](context, data) {
    return new Promise((resolve, reject) => {
      context.commit('SET_LOADINGTABLE', true)
      ApiService.get(`settings/role-menu?page=${data.page}&limit=${data.limit}${data.keyword ? `&keyword=${data.keyword}` : ''}`, token)
      .then((response) => {
          context.commit('SET_LOADINGTABLE', false)
  ...
  [POST_ROLEMENU](context, bodyData) {
    return new Promise((resolve, reject) => {
      ApiService.post(`settings/role-menu`, token, bodyData)
      .then((response) => {
          resolve(response);
        })
        .catch((error) => {
  ...
  [GET_LIST_EXAM](context, data) {
    return new Promise((resolve, reject) => {
      ApiService.get(`settings/list-exam${data.kelas ? `?kelas=${data.kelas}` : ''}`, token)
      .then((response) => {
