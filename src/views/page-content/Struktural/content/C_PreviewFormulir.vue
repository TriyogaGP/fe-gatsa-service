          ...
          {{ kelasText }}
			...
			<v-row no-gutters>
				...
				<v-col
					...
					class="pt-3"
				>
          {{ DataStepThree.wali_kelas ? DataStepThree.wali_kelas : '-' }}
				</v-col>
			</v-row>
		</v-card>
    <v-row no-gutters>
...
export default {
  ...
  data: () => ({
	...
	setup(){
		...
		return { DataStepOne, DataStepTwo, DataStepThree } 
	},
	computed: {
		...mapState({
	...
	methods: {
      ...
      let bodyData = {
        ...
        userdetail: {
          nomorInduk: this.DataStepThree.nomor_induk,
